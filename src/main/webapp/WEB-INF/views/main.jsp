            ...
            <div class="sort">
                <div class="sort-channel">
                    <ul class="sort-channel-list list-group">
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=川菜">川菜</a>
...
<%--                                    </dt>--%>
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=酸菜鱼">酸菜鱼</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=鱼香肉丝">鱼香肉丝</a> <a href="">麻婆豆腐</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=回锅肉">回锅肉</a>
                                    </dd>
...
<%--                                </dl>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=东北菜">东北菜</a>
...
<%--                                    </dt>--%>
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=锅包肉">锅包肉</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=排骨炖小土豆">排骨炖小土豆</a> <a href="">酱骨头</a> <a
                                            href="">木须肉</a>
                                    </dd>
<%--                                        <dd>--%>
...
<%--                                </dl>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=粤菜">粤菜</a>
...
<%--                                    </dt>--%>
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=清蒸鲈鱼">清蒸鲈鱼</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=菠萝咕噜肉">菠萝咕噜肉</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=孔雀开屏鱼">孔雀开屏鱼</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=梅菜扣肉">梅菜扣肉</a>
                                    </dd>
                                </dl>
<%--                                <dl class="dl-hor">--%>
<%--                                    <dt>--%>
...
<%--                                </dl>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=湘菜">湘菜</a>
<%--                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=服饰">香菜</a>--%>
...
<%--                                    </dt>--%>
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=腊味合蒸">腊味合蒸</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=农家小炒肉">农家小炒肉</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=剁椒鱼头">剁椒鱼头</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=左宗棠鸡">左宗棠鸡</a>
                                    </dd>
                                </dl>
<%--                                <dl class="dl-hor">--%>
<%--                                    <dt>--%>
...
<%--                                </dl>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=凉菜">凉菜</a>
...
<%--                                    </dt>--%>
                                    <dd>
                                        <a href="${pageContext.request.contextPath}/category?cate=皮蛋拌豆腐">皮蛋拌豆腐</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=凉拌海带丝">凉拌海带丝</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=凉拌藕片">凉拌藕片</a> <a
                                            href="${pageContext.request.contextPath}/category?cate=围巾">玫瑰山药</a>
<%--                                        <a--%>
            ...
            <div id="mycarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="${pageContext.request.contextPath}/image/suancai.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="${pageContext.request.contextPath}/image/baozi.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="${pageContext.request.contextPath}/image/jipai.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="${pageContext.request.contextPath}/image/meishi.jpg" alt="">
                    </div>
                </div>
        ...
        <c:if test="${!empty xiangCai}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${xiangCai}" var="xiangCai">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${xiangCai.goodsid}"> <img
                                                src="/shopimage/${xiangCai.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${xiangCai.goodsid}">${xiangCai.goodsname}</a>
                                    </p>
                                    <div class="text-right">
                                        <b>￥${xiangCai.price}</b>
                                    </div>
                                    <div>
                                        <c:if test="${xiangCai.fav}">
                                            <button
                                                    class="like-button glyphicon glyphicon-heart btn btn-default"
                                                    data-id="${xiangCai.goodsid}"
                                                    style="display: none;"></button>
                                        </c:if>
                                        <c:if test="${!xiangCai.fav}">
                                            <button
